!(function (e, t) {
  ...
  function t(e, t) {
    ...
    if (n) {
      if (
        ...
        throw new Error(
          '"options.position" must be one of the following: tl, tr, bl, or br.'
        );
      e.position = o(n);
    ...
    if (
      (["startDate", "dateSelected", "minDate", "maxDate"].forEach(function (
        ...
        if (e[t]) {
          if (!f(e[t]) || isNaN(+e[t]))
            throw new TypeError(
              '"options.' + t + '" needs to be a valid JavaScript Date object.'
            );
          e[t] = p(e[t]);
        }
      }),
    ...
    return (
      ...
      [u, d].forEach(function (t, n) {
        t &&
          t.split &&
          (n ? (e.overlayButton = t) : (e.overlayPlaceholder = t));
      }),
      e
    );
  }
  ...
  function s(e, t) {
    ...
    for (var y = 1; y <= v; y++) {
      ...
      +S != +r || g || (w += " qs-active"),
        p.push(
          '<div class="qs-square qs-num ' + m + " " + w + '">' + b + "</div>"
        );
    }
    var x = c
      .map(function (e) {
    ...
    if (x.length % 7 != 0) {
      throw new Error(
        "Calendar not constructed properly. The # of squares should be a multiple of 7."
      );
    }
 ...
 /* function u(e, t, n) {
  ...
  function q(e) {
    ...
    if (!this.isMobile || !this.disableMobile) {
      if (!e.path) {
        for (var r = e.target, a = []; r !== document; )
      ...
      if ("keydown" === s) {
        ...
        if (13 === e.which && !q.classList.contains("qs-hidden"))
          return e.stopPropagation(), o(e, l, this);
